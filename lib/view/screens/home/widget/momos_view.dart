...
// class MomosView extends StatelessWidget {
//   @override
//   Widget build(BuildContext context) {
//     return Consumer<ProductProvider>(builder: (context, productProvider, child) {
//       return productProvider.momoList != null ? Column(children: [
...
//           Navigator.pushNamed(context, RouteHelper.MomosRoute());
//         }),

//         ResponsiveHelper.isDesktop(context)
//             ?  GridView.builder(
//                   itemCount: productProvider.momoList.length >= 10 ? 10 : productProvider.momoList.length,
...
//                       return listViewMomoItem(context: context,index: index,productProvider: productProvider);
//                     },
//                   )
...
//             itemCount: productProvider.momoList.length,
...
//     });
//   }
//   Widget listViewMomoItem({BuildContext context, int index, ProductProvider productProvider}){
//     return Padding(
//       padding: EdgeInsets.only(right: Dimensions.PADDING_SIZE_SMALL),
//       child: InkWell(
//         onTap: () {
//           Navigator.of(context).pushNamed(RouteHelper.getProductDetailsRoute(product: productProvider.momoList[index]),
//               arguments: ProductDetailsScreen(product: productProvider.momoList[index]));
//         },
//         child: Container(
//           width: 150,
...
//                       '/${productProvider.momoList[index].image[0]}',
...
//               Text(
//                 productProvider.momoList[index].name,
//                 style: poppinsMedium.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL),
//                 maxLines: 1, overflow: TextOverflow.ellipsis,
//               ),

//               Text(
//                 '${productProvider.momoList[index].capacity} ${productProvider.momoList[index].unit}',
...
//                         context, productProvider.momoList[index].price,
//                         discount: productProvider.momoList[index].discount,
//                         discountType: productProvider.momoList[index].discountType,
//                       ),
//                       style: poppinsBold.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL),
//                     ),

//                     productProvider.momoList[index].discount > 0 ? Text(
//                       PriceConverter.convertPrice(
//                         context, productProvider.momoList[index].price,
//                         discount: productProvider.momoList[index].discount,
//                         discountType: productProvider.momoList[index].discountType,
